      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          ...
          <p className="mt-4 text-base leading-7 text-[#B3B3B3]">
            Prueba PaySync gratis, ordena tus cobros desde el primer dia y luego continua con un abono mensual simple.
          </p>
        </div>
        ...
        <div className="rounded-[28px] border border-[#00C896]/20 bg-[#101010] p-6 shadow-[0_24px_90px_rgba(0,0,0,0.35)]">
          ...
          <div className="mt-6 grid gap-3">
            ...
            <PriceItem text="Configuracion inicial en minutos" />
            <PriceItem text="Sin implementacion larga ni vueltas" />
          </div>
          <button
            type="button"
